...
## О работе
- Погодаева Мария Игоревна
- https://colab.research.google.com/drive/17MPDxPyJlasTdWu8e-EXl2f_ZhW4LyD1
...
1. Посчитать сколько объектов попадает в заданный буфер вокруг улицы.
